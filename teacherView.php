...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="uploadLecture.php">Upload lecture</a>
                </li>
                <li class="nav-item">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            $sql = "SELECT * FROM lecturelinks WHERE teacherid='$teacherId'";
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    <td><a href="deleteLecture.php?slno=' . $row['slno'] . '">Delete</a></td>
                </tr>';
                }
            } else {
